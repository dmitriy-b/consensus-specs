...
from eth2spec.phase0 import mainnet as spec_mainnet, minimal as spec_minimal, gnosis as spec_gnosis
from eth2spec.test.helpers.constants import PHASE0, MINIMAL, MAINNET, GNOSIS
